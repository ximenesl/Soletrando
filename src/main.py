...
class SoletrandoApp(ctk.CTk):
    def __init__(self):
        ...
        logo_image = ctk.CTkImage(
            light_image=Image.open(os.path.join(_SCRIPT_DIR, "assets", "img", "SOLETRANDO.png")),
            dark_image=Image.open(os.path.join(_SCRIPT_DIR, "assets", "img", "SOLETRANDO.png")),
            size=(300, 80)
        )
    ...
    def load_words_for_level(self):
        ...
        filepath = os.path.join(_SCRIPT_DIR, "word_lists", f"{level}_ano.txt")
        try:
