...
class ReconhecimentoVozPC:
    ...
    def ouvir_soletracao(self, callback_letra: callable, callback_final: callable):
        """Inicia o reconhecimento contínuo de letras."""
        self.escutando = True
        soletracao_atual = ""
        ...
        with sr.Microphone() as source:
            ...
            while self.escutando:
                try:
                    ...
                    # Tenta encontrar a letra correspondente
                    ...
                    if pontuacao >= 80:
                        ...
                        callback_letra(soletracao_atual) # Atualiza a UI com a nova letra
                    else:
                    ...
                    break # Sai do loop se o serviço falhar
